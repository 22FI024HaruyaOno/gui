...
class GUIAniMultiTCPClient2 {
    ...
    GUIAniMultiTCPClient2() {// コンストラクター
        ...
        System.out.println("input command Sample:");
        System.out.println("face,place,0,100,200");
        System.out.println("commandList:");
        System.out.println("place,index,x,y");
        System.out.println("color,index,colorName");
        System.out.println("emotion,index,normal/angry/smile");
        System.out.println(":");
        while (true) {
            try {
                // コマンド入力用
